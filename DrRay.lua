...
function UILIB.newTab(name, img)	
	...
	DRR["4"].CanvasSize = UDim2.new(DRR["5"].AbsoluteContentSize.X / DRR["33"].AbsoluteSize.X , 0, 0, 0)
	...
	function self.newSlider(Name, Desc, Max, Min, ManageSlider, Increment, Func)
        ...
        local function Update()
            ...
            repeat
                ...
                local Range = Max - Min
                local CenteredPercent = (Percent * Range) + Min
                Perc = math.round(CenteredPercent / Increment) * Increment
