...
function UILIB.newTab(name, img)	
	...
	function self.newSlider(Name, Desc, Max, ManageSlider, Increment, Func)
        Name = Name or "Slider"
        ...
        local function Update()
            ...
            repeat
                ...
                Perc = math.round(Percent * Max / Increment) * Increment
                ...
                local Tween = TweenService:Create(Fill, TweenInfo.new(DelayTw, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.fromScale(Percent, 1) })
                Tween:Play()
